...
const headerGroup = reactive({
  ...
  headRow2: [
    ...
    { name: '평가점수', rowspan: 1, colspan: 1, key: 'totalSelfPoint' },
...
const excelExport = (data, options) => {
  ...
  XLSX.utils.book_append_sheet(wb, ws, '성과평가집계표');
  XLSX.writeFile(wb, '성과평가집계표.xlsx');
};
</script>

<style scoped>
@import 'src/css/print/hrt1020.css';
</style>
