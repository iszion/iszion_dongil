          ...
          <div id="printZone">
            ...
            <table>
              <tr>
                ...
                <th rowspan="2" colspan="1">평가구분</th>
...
const headerGroup = reactive({
  header: [],
  headProps: ['deptNm', 'titlNm', 'empNm', 'evsNm', 'itemFgNm', 'itemNm', 'weight', 'markPoint', 'markPointX'],
  headRow1: [
    { name: '소속팀', rowspan: 1, colspan: 2 },
    { name: '성명', rowspan: 2, colspan: 1, key: 'empNm' },
    { name: '평가구분', rowspan: 2, colspan: 1, key: 'evsNm' },
  ...
  headRow2: [
    ...
    { name: '역량점수', rowspan: 1, colspan: 1, key: 'markPoint' },
...
const excelExport = (data, options) => {
  ...
  XLSX.utils.book_append_sheet(wb, ws, '역량평가현황');
  XLSX.writeFile(wb, '역량평가현황.xlsx');
};
</script>

<style scoped>
@import 'src/css/print/hrt2010.css';
</style>
