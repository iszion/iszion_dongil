        ...
        <q-card-section class="q-pt-none">
          ...
          <div id="printZone">
            <div class="row q-px-xs">
              ...
              <span class="text-h6 q-ml-sm">[ {{ props.slidTitle }} ] </span>
              <span class="text-h6 q-ml-sm"> 인사평과 결과보고서</span>
              <q-space />
            </div>

            <table>
              <tr>
                <th rowspan="1" colspan="3">소속</th>
                <th rowspan="2" colspan="1">성과평가</th>
...
const headerGroup = reactive({
  header: [],
  headProps: ['deptNm', 'titlNm', 'empNm', 'evaP1X', 'evaP2X', 'evaP2Xx', 'evaAtt', 'evaFinalPoint'],
  headRow1: [
    { name: '소속', rowspan: 1, colspan: 3 },
    { name: '성과평가', rowspan: 2, colspan: 1, key: 'evaP1X' },
  ...
  headRow2: [
    ...
    { name: '편차적용(전)', rowspan: 1, colspan: 1, key: 'evaP2X' },
    { name: '편차적용(후)', rowspan: 1, colspan: 1, key: 'evaP2Xx' },
  ],
});
...
const excelExport = (data, options) => {
  ...
  XLSX.utils.book_append_sheet(wb, ws, props.slidTitle);
  XLSX.writeFile(wb, props.slidTitle + '_인사평가결과.xlsx');
};
</script>

<style scoped>
@import 'src/css/print/hrt6010p.css';
</style>
